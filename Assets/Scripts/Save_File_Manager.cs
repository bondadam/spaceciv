...
{
    public static List<string> getAllSimpleFileNames()
    {
        ...
        {
            simple_file_names.Add(getSimpleFileName(str));
        }
        return simple_file_names;
    }

    public static string getSimpleFileName(string file_path)
    {
        var cuts = file_path.Split('/');
