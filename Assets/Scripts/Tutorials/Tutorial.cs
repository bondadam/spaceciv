...
public class Tutorial : MonoBehaviour
{
    ...
    public int state = 0;
    public void Initialize(Show_Tutorial_Finger show_finger, Clear_Tutorial_Finger clear_finger, Show_Tutorial_Text show_text, Clear_Tutorial_Text clear_text, Get_Structure_Position get_structure_position, Get_Nth_Structure get_nth_structure)
    {
