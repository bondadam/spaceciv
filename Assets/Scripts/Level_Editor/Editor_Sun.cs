...
public class Editor_Sun : Editor_Object
{
    ...
    public void Initialize(Vector2 coords, On_Destroy_Callback on_destroy){
        ...
        this.sizeSlider.maxValue = Constants.SUN_MAX_SIZE;
        this.sizeSlider.minValue = Constants.SUN_MIN_SIZE;
        this.sizeSlider.value = Constants.SUN_DEFAULT_SIZE;
        this.sizeValue.text = Constants.SUN_DEFAULT_SIZE.ToString();
